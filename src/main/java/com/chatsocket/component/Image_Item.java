...
import com.chatsocket.event.EventFileSender;
...
import com.chatsocket.swing.blurHash.BlurHash;
...
public class Image_Item extends javax.swing.JLayeredPane {
    ...
    private void initComponents() {
        ...
        progress = new com.chatsocket.swing.Progress();

        progress.setBorder(null);
        progress.setForeground(new java.awt.Color(255, 255, 255));
        progress.setProgressType(com.chatsocket.swing.Progress.ProgressType.CANCEL);
    ...
    private com.chatsocket.swing.Progress progress;
